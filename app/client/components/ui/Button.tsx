...
export const Button = forwardRef<HTMLButtonElement, Props>(function Button(
  ...
  const variants = {
    primary:
      'px-4 py-2 bg-sage text-ink-900 rounded-[5px] hover:bg-sage/90 hover:-translate-y-px hover:shadow-soft-lift',
    ghost:
      'px-4 py-2 hairline rounded-[5px] text-ink-100 hover:bg-ink-700 hover:-translate-y-px',
